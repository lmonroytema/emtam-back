...
class UpdateTenantSettingsRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'notifications_channel' => ['sometimes', Rule::in(['email', 'whatsapp', 'both', 'email_sms'])],
            ...
            'test_notification_sms_numbers' => ['sometimes', 'nullable', 'array'],
            'test_notification_sms_numbers.*' => ['required', 'string', 'regex:/^\+?\d{8,15}$/'],
